                        ...
                        <FORM id="pageForm" name="customerForm"
                            ...
                            <TABLE cellSpacing=0 cellPadding=2 border=0>
                                ...
                                <TR>
                                    <TD>业务员名称：</TD>
                                    <TD>
                                        <input style="WIDTH: 80px" maxLength=50 name="user.user_name"
                                               id="user.user_name" value="${param['user.user_name']}"/>
                                    </TD>
                                    <TD>客户名称：</TD>
                                    <TD>
                                        ...
                                        <input type="button" value="选择客户"
                                               onclick="window.open('${pageContext.request.contextPath}/customerAction_list?selectWindow=select','','width=600,height=300')"/>
                                    </TD>
                        ...
                        <TABLE id=grid
                            ...
                            <s:iterator value="#pageBean.list">
                                <TR
                                    ...
                                    <TD>
                                        <!-- 没有传递参数,显示删除和修改操作 -->
                                        <a href="${pageContext.request.contextPath }/saleVisitAction_toList?visit_id=<s:property value="visit_id" />">修改</a>
                                        &nbsp;&nbsp;
